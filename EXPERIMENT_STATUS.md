...
| E100 | cause decomposition of the falling curve (e)(a)(b)(c)(d) | PARTIAL | `results/E100_cause/` (CRITERIA.md pre-registered 69102f2; r2, r8, r2_val, r8_val) | r8 short-window retrain (running) | (e) real: 0.022 of the all-voxel fall, and the *whole* fall of the support-top-25 % curve, which rises monotonically to N=16 and saturates under a fixed reference (drop16 −0.048 / −0.054); precision falls with N at every operating point; (c)(d) not distinct causes, (b) the mechanism of the precision decline; (a) short windows (128/64 at hop 32) and the hop-only control (400/32) change nothing: single-view MAE −0.003/−0.007/−0.003, drop16 +0.041/+0.032/+0.036 | close; next question is the 0.56 saturation | 0ea8ea1 |
