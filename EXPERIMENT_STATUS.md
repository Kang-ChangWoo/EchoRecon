...
| E30-E32 | same-backbone comparison | DONE | `results/E30_stage_d/r2/` (7020 rows, N = 1/2/4/8/16/all) | other observation sets | point and argmax agree at N=1 (0.572 / 0.576 F1); full posterior falls with N exactly as they do and is worse from N=4 on | CASE 4: hypothesis not supported | Stage D |
