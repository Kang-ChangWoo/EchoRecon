...
| E50-E51 | free-space ablation | DONE as E100 (d) | `results/E100_cause/{r2,r8}/` contra0/1/2 rows | | contra1 (drop if contradictions >= supporting views) recovers 0.036 / 0.039 of the N=4→16 fall and lifts F1(all) by 0.05; the curve no longer falls under the fixed reference | E100 | 8a8007f |
...
| E100 | cause decomposition of the falling curve (e)(a)(b)(c)(d) | PARTIAL | `results/E100_cause/` (CRITERIA.md pre-registered 69102f2; r2, r8, r2_val, r8_val) | (a) short-window retrains (`outputs/base_retrain/oaa_r2_w{128,64,400}_h32`) and the (c)(d) re-measurement on them | (e) real, recovery 0.022 (below band); fall survives with a fixed reference (drop16 0.034/0.037, precision 0.51→0.35); (d) is the only cause clearing the bar | finish (a) | 0ea8ea1 |
