...
| E100 | cause decomposition of the falling curve (e)(a)(b)(c)(d) | PARTIAL | `results/E100_cause/` (CRITERIA.md pre-registered 69102f2; r2, r8, r2_val, r8_val) | (a) short-window retrains (`outputs/base_retrain/oaa_r2_w{128,64,400}_h32`) and the (c)(d) re-measurement on them | (e) real: 0.022 of the all-voxel fall, and the *whole* fall of the support-top-25 % curve, which rises monotonically to N=16 and saturates under a fixed reference (drop16 −0.048 / −0.054); precision falls with N at every operating point; (c)(d) not distinct causes, (b) the mechanism of the precision decline | finish (a) | 0ea8ea1 |
